...
[{
	...
	(_this select 0) setVariable ["FLCSL_lastIndexPos", getPosASL (_this select 0), true];
	(_this select 0) setVariable ["FLCSL_nextIndexPos", getPosASL ((_this select 0) getVariable "FLCSL_nextIndex"), true];
